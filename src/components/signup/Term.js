...
const Term = () => {
  return (
    <div style={{height: 250, overflow: 'auto'}}>
      ...
      도미솔(이하 ‘회사’라 한다)은 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립․공개합니다. 
      </Typography>
      <Typography variant="body2">
...
제4조(개인정보처리의 위탁) ① 회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다. 
  ...
  1. 메일 상담센터 운영 
   - 위탁받는 자 (수탁자) : 도미솔 개발자
   - 위탁하는 업무의 내용 : 상담 응대, 부서 및 직원 안내 등 
      </Typography>
      <Typography variant="body2">
  ...
  2. 재화 또는 서비스 제공  
    ․필수항목 : 성명, 생년월일, 아이디, 비밀번호, 주소, 전화번호, 이메일주소, 아이핀번호 
...
-아래의 기관은 회사와는 별개의 기관으로서, 회사의 자체적인 개인정보 불만처리, 피해구제 결과에 만족하지 못하시거나 보다 자세한 도움이 필요하시면 문의하여 주시기 바랍니다-
 ...
 ▶ 경찰청 사이버안전국 : 182 (http://cyberbureau.police.go.kr)
      ...
      <Typography variant="body2">
      제13조(영상정보처리기기 설치․운영) ① 도미솔 은(는) 영상정보처리기기를 설치․운영하지 않습니다.

제14조(개인정보 처리방침 변경) ① 이 개인정보 처리방침은 2020. 11. 1부터 적용됩니다.
      </Typography>
    </div>
  );
};
